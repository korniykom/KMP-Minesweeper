...
-keepclasseswithmembers public class com.korniykom.minesweeper.MainKt {  # <-- Change com.company to yours
...
-keep,includedescriptorclasses class com.korniykom.minesweeper.**$$serializer { *; }  # <-- Change com.korniykom.minesweeper
-keepclassmembers class com.korniykom.minesweeper.** {  # <-- Change com.korniykom.minesweeper to yours
    *** Companion;
}
-keepclasseswithmembers class com.korniykom.minesweeper.** { # <-- Change com.korniykom.minesweeper to yours
    kotlinx.serialization.KSerializer serializer(...);
}
